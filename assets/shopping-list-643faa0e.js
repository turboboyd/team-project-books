import{a as v,b as w,c as S,d as T,e as M,f as y}from"./book-shop@2x-ba4b7e4d.js";function l(t){try{return JSON.parse(localStorage.getItem(t))}catch(e){console.log(e)}}function _(t){return t.map((n,s)=>`<li class="shopping-item">
    <img
