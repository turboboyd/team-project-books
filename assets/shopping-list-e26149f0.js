import{n as z,b as W,s as b,a as x,d as j,e as B,f as R,h as V,i as M,g as D}from"./book-shop@2x-b00f7024.js";function c(t){try{return JSON.parse(localStorage.getItem(t))}catch(n){console.log(n),z.Notify.failure(`${n}`)}}function J(t){return t.map((e,i)=>`<li class="shopping-item">
    <img 
