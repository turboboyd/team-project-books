import{s as m,a as x,b as N,c as B,d as A,e as z,f as M}from"./book-shop@2x-397bd6a9.js";function r(t){try{return JSON.parse(localStorage.getItem(t))}catch(n){console.log(n)}}function W(t){return t.map((e,i)=>`<li class="shopping-item">
    <img
