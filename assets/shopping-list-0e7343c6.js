import{n as z,s as b,a as x,b as W,d as M,e as j,f as R,g as T}from"./book-shop@2x-6df333a3.js";function c(t){try{return JSON.parse(localStorage.getItem(t))}catch(n){console.log(n),z.Notify.failure(`${n}`)}}function V(t){return t.map((e,i)=>`<li class="shopping-item">
    <img
